...
class CreateBookingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('bookable_bookings', function (Blueprint $table) {
            ...
            $table->foreignId('bookable_configuration_slot_id')->nullable();            
            $table->foreign('bookable_configuration_slot_id')->references('id')->on('bookable_configuration_slots')->onDelete('cascade');            
